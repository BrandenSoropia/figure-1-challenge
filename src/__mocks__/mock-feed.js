/**
 * Notice that there are 2 values for `type`: "post" and "comment".
 *
 * Comments have `postID` and `comments`.
 */
export const mockRawFeed = [
  {
  ...
  },
  {
    ...
    image: {
      ...
      post:
        "https://images.unsplash.com/photo-1516716984596-1f6e47c5e986?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=0303fcb116aa42fe677673e6fe1fa3f6&auto=format&fit=crop&w=400&q=60",
    },
    stats: {
      star: 3,
      follow: 15,
  ...
  },
  {
    ...
    image: {
      ...
      post:
        "https://images.unsplash.com/photo-1526224617767-e92ff8a3fb71?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=085ffc8f79c50b58976278b65bb523c6&auto=format&fit=crop&w=400&q=60",
    },
    stats: {
      star: 14,
      follow: 23,
  ...
  },
  {
    ...
    image: {
      profile:
        "https://images.unsplash.com/profile-fb-1509503094-d0ee56e8483c.jpg?dpr=1&auto=format&fit=crop&w=64&h=64&q=60&crop=faces&bg=fff",
    },
    comments: [
      {
  ...
  },
  {
    ...
    image: {
      ...
      post:
        "https://images.unsplash.com/photo-1506691098651-355ab2a13aed?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=0a3741c6b552a5c0d334731229c77bf2&auto=format&fit=crop&w=400&q=60",
    },
    stats: {
      star: 17,
      follow: 4,
